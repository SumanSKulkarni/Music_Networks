function [C,acc] =clustering_coef_bd(A)
...
% Modification by Suman: calculate the number of directed transitive triangles
% To do this, we subtract the 3-cycles

S=A+A.';                    %symmetrized input graph
K=sum(S,2);                 %total degree (in + out)
cyc3=diag(S^3 - A^3 - (A')^3)/2;           %(ie. directed triangles)
